...
class mDokumen extends CI_Model {
	...
	function getDokumen($kd_sertifikasi_dokumen='',$kd_sertifikasi_jenistarif='',$result=false) {
		...
		$this->db->select('order_sertifikasi_dokumen_list.*');
	...
	function getDocumentList($kd_order_sertifikasi_dokumen){
		$this->db->select('order_sertifikasi_dokumen_list.*, mst_sertifikasi_jenis_tarif_dokumen.kd_sertifikasi_jenistarif, mst_sertifikasi_jenis_tarif_dokumen.nama_sertifikasi_dokumen, mst_sertifikasi_jenis_tarif_dokumen.jenis_dokumen');
		$this->db->from('order_sertifikasi_dokumen_list');
		$this->db->join('mst_sertifikasi_jenis_tarif_dokumen', 'order_sertifikasi_dokumen_list.kd_sertifikasi_dokumen = mst_sertifikasi_jenis_tarif_dokumen.kd_sertifikasi_dokumen');
		$this->db->where('order_sertifikasi_dokumen_list.kd_order_sertifikasi_dokumen', $kd_order_sertifikasi_dokumen);
		$this->db->order_by('mst_sertifikasi_jenis_tarif_dokumen.kd_sertifikasi_jenistarif');
