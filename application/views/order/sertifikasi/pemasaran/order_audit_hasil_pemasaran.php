    ...
    <p>&nbsp;</P>
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-6"><?=$tgl_temuan_audithasil;?></div>       
                </div>
            </div>
            <div class="row">
                <div class="form-group">
                    <label   class="col-sm-3 control-label">Tanggal Hasil Audit Diterima dari Auditor </label>
                    <div class="col-sm-6"> <?=$tgl_diterima_audithasil;?></div>     
                </div>
            </div>
			...
			if($resultOrderAuditHasilPerbaikan)	
				$this->load->view('order/sertifikasi/pemasaran/view_order_audit_hasil_perbaikan_pemasaran.php');
			?>
                    </div>
				</div>
        	</div>
