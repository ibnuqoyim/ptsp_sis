                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6"><?=form_error('kd_sertifikasi_jenis')?> 
                            <?=form_dropdown('kd_sertifikasi_jenis',$this->mTarif->GetJenisSertifikasiList4DropDown(),
                                $kd_sertifikasi_jenis,'class="form-control" disabled="disabled" onChange="showTarifSertifikasi()" id="kd_sertifikasi_jenis"');?> 
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-6"><?=form_error('kd_sertifikasi_jenistarif')?> 
                            <select name="kd_sertifikasi_jenistarif" class="form-control" disabled='disabled' id="kd_sertifikasi_jenistarif">                 
                            <?php 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">                         
                            <?=form_dropdown('kd_sertifikasi_tahapan',$this->mOrder->getTahapanList4DropDown(),
                                ...
                                'class="form-control"  disabled="disabled" id="kd_sertifikasi_tahapan"');?>                                
