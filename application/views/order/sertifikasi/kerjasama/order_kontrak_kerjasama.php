...
<p><?=@$this->errormsg;?></p>
	...
	<input type="hidden" name="save" id="save" value="1" />
            ...
            <div class="row">
                <div class="form-group">
                    <label   class="col-sm-3 control-label">Nama Penandatangan Kontrak BBK </label>
                    <div class="col-sm-6">  
             ...
             <div class="row">
                <div class="form-group">
                    <label   class="col-sm-3 control-label">NIP Penandatangan Kontrak BBK </label>
                    <div class="col-sm-6">  
             ...
             <div class="row">
                <div class="form-group">
                    <label   class="col-sm-3 control-label">Jabatan Penandatangan Kontrak BBK </label>
                    <div class="col-sm-6">  
            ...
            <div class="row">
                <div class="form-group">
                    <label   class="col-sm-3 control-label">Tanggal Sertifikat ditandatangani Pihak BBK</label>
                    <div class="col-sm-6">  
