             ...
             <div class="row">
        		<div class="form-group">
                    ...
                    <div class="col-sm-6"><?=form_error('nama_perusahaan_pemohon')?>      
                            ...
                            value="<?=$nama_perusahaan_pemohon;?>" class="form-control" placeholder="otomatis">   
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">  <?=form_error('noreg_order_sertifikasi')?>                      
                            <?=form_input(array('name'=>'noreg_order_sertifikasi','class'=>'form-control',
                                'value'=>$noreg_order_sertifikasi,'maxlength'=>'100','size'=>'20', 'readonly'=>'true'));?> 
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">                        
                            ...
                            'class'=>'input-text','size'=>'10','maxlength'=>'10', 'readonly'=>'true'));?> 
