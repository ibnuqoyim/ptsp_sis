   ...
   <div style="clear:both"></div>
	...
	<div>
		<ul class="nav nav-tabs" id="myTab">
    		...
    		<li class="active"><a href="<?=base_url();?>index.php/order/orderAuditor/<?=$kd_order_sertifikasi;?>">Auditor</a></li>
...
<p><?=@$this->errormsg;?></p>
	...
	<input type="hidden" name="save" id="save" value="1" />
        	...
        	<? 
			if($result)	
				$this->load->view('order/sertifikasi/administrator/view_order_auditor_administrator.php');
			?>
				</div>
        	</div>
