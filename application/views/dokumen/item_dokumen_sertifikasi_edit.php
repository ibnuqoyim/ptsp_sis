...
<?=form_open(current_url());?>
    ...
    <input type="hidden" name="kd_sertifikasi_jenis" value="<?=$kd_sertifikasi_jenis;?>" id="kd_sertifikasi_jenisn" />
    <input type="hidden" name="kd_satker" value="<?=$kd_satker;?>" id="kd_satker" />
