...
<p><?=anchor(site_url()."/".$this->uri->segment(1),"Menu Customer")." &raquo; Tambah Customer";?></p>
<p><?=$this->errormsg;?></p>
<?=form_open(current_url());?>
<div class="steptitle">Step 1</div>
<div class="wizard-steps">
  <div class="active-step"><a href="index.php/customer/Add"><span>1</span> Data Customer</a></div>
  <div><a href="Step 2" onclick="return false"><span>2</span> Detail Komoditi Customer</a></div>  
</div>
...
<fieldset><legend><b><?=$this->judul;?></b></legend>
    ...
    <div class="row">
        		<div class="form-group">
        			<label  class="col-sm-3 control-label">Alamat Perusahaan / Orang</label>
        			<div class="col-sm-6">        					
