...
<input type="hidden" name="nip_penyelia" value="<?=$nip_penyelia;?>" >
<input type="hidden" name="nm_penyelia" value="<?=$nm_penyelia;?>" >
  ...
  <tr>
	 ...
	 <table width="550" border="0" cellspacing="3" cellpadding="0">
		...
		<td width="300" valign="top" >
			...
			'value'=>$tgl_dibuat_penyelia,'id'=>'tgl_dibuat_penyelia',
