...
<table width="550" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	 ...
	 <table width="550" border="0" cellspacing="3" cellpadding="0">
		...
		<td width="300" valign="top" >
			<?php 
			$options= array('Diperiksa' => 'Diperiksa',
		...
		<td width="20" valign="top" ><div align="center">:</div></td>
		<td width="300" valign="top" >
			<input type="hidden" name="nip_wmanajer_teknis" value="<?=$dat1->nip_baru;?>" >
			<input type="hidden" name="nm_wmanajer_teknis" value="<?=$dat->Nama;?>" >
			<?=form_input(array('name'=>'tgl_disetujui_wmanajer_teknis','class'=>'input-option',
			'value'=>$tgl_disetujui_wmanajer_teknis,'id'=>'tgl_disetujui_manajer_teknis',
	...
	<td width="413" valign="top">
		<?=form_textarea(array('name'=>'comment_wmanajer_teknis','class'=>'tinymcemini',
		'value'=>$comment_wmanajer_teknis,'cols'=>'50','rows'=>'1'));?>
	</td>
     </tr>			  
	    <tr>
