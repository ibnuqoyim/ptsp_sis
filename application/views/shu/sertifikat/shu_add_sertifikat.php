...
<input type="hidden" name="nip_pengetik_sertifikat" value="<?=$dat1->nip_baru;?>" >
<input type="hidden" name="nm_pengetik_sertifikat" value="<?=$dat->Nama;?>" >
...
<table width="550" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	 ...
	 <table width="550" border="0" cellspacing="3" cellpadding="0">
		...
		<td width="20" valign="top" ><div align="center">:</div></td>
		<td width="300" valign="top" >
			<?php $options= array('selesai' => 'Selesai','diperbaiki'=> 'Diperbaiki',); ?>
		...
		<td width="300" valign="top" >
			...
			'value'=>$tgl_dibuat_pengetik_sertifikat,'id'=>'tgl_dibuat_pengetik_sertifikat','size'=>'10','maxlength'=>'10'));?>
			<style type="text/css">.embed + img { position: relative; left: -21px; top: -1px; }</style>
		</td>
            </tr>
	    <tr>
	...
	<td width="20" valign="top" class="input-text-1" style="vertical-align:text-top"><div align="center">:</div></td>
	<td width="413" valign="top">
		<?=form_textarea(array('name'=>'brand_komoditi','class'=>'tinymcemini','value'=>$brand_komoditi,'cols'=>'50','rows'=>'1'));?>
	</td>
     </tr>
     <tr>
	...
	<td width="413" valign="top">
     ...
     <tr>
		...
		<td width="20" valign="top" ><div align="center">:</div></td>
		<td width="300" valign="top" >
					<?=($file_shu !="")?"<a href='$file_shu' target='_blank'>".
					basename($file_shu )."</a>":"-";?>
	    </td>
            </tr>	
	</table>
