...
<div>
		<ul class="nav nav-tabs" id="tabs" class="tabs">
...
<ul class="breadcrumb">
    <li><a href="<?=site_url()."/".$this->uri->segment(1)."/JenisSertifikasi/";?>">Jenis</a></li>
    <li><a href="<?=site_url()."/".$this->uri->segment(1)."/".$this->uri->segment(2)."/".$this->uri->segment(3);?>">
    	<?=$nama_sertifikasi_jenis;?></a></li>
    <li class="active"><?=$nama_jenistarif;?>Tambah</li>
</ul>
<p><?=$this->errormsg;?></p>
