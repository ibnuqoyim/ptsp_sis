...
<p><center><h3><font color="red">Opsi Lain</font></h3></center></p>
	...
	<input type="hidden" name="save" id="save" value="1" />
            ...
            <div class="row">
                <div class="form-group">
                    <label   class="col-sm-3 control-label">Tanggal Temuan </label>
                    <div class="col-sm-6">  
			...
			if($resultOrderAuditHasilPerTemuan)	
				$this->load->view('order/sertifikasi/administrator/view_order_audit_hasil_pertemuan_administrator.php');
			?>
				</div>
        	</div>
