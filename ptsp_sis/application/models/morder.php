  ...
  function saveOrderSertifikasi($arr,$kd_order_sertifikasi='',$edit=false){    
      ...
      if($edit){
          ...
          if(isset($arr['status_order_sertifikasi'])) $this->db->set('nama_step_status',$step_status->nama_step_status); 
              else $this->db->set('nama_step_status','Proses Registrasi Permohonan Sertifikasi');
	  ...
	  if(isset($arr['tgl_create'])) $this->db->set('tgl_create',$arr['tglreg_order_sertifikasi']); 
              else $this->db->set('tgl_create',date('Y-m-d'));
...
function saveOrderDokumen($arr,$kd_order_sertifikasi_dokumen='',$dokumenlist='', $edit=false){
...
function deletePenawaran($kd_order_sertifikasi,$kd_penawaran){
    //echo "<script>alert('hapus2')</script>";
    $this->db->where('kd_order_sertifikasi',$kd_order_sertifikasi);
    $this->db->where('kd_penawaran',$kd_penawaran);
    return $this->db->delete('order_sertifikasi_penawaran');
}

function deletePenawaranList($kd_order_sertifikasi,$kd_penawaran){
    //echo "<script>alert('hapus2')</script>";
    $this->db->where('kd_order_sertifikasi',$kd_order_sertifikasi);
    $this->db->where('kd_penawaran',$kd_penawaran);
    return $this->db->delete('order_sertifikasi_penawaran_list');
}
